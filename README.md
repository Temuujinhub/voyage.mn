...
2. GitHub → repo **Settings → Secrets and variables → Actions → New repository secret** дээр дараах 7 secret-ийг нэмнэ:
   ...
   ⚠️ Нууц утгуудыг заавал **`-hex`** (base64 биш)-ээр үүсгээрэй — base64 нь `/`, `+`
   тэмдэгт агуулдаг тул `.env`-д асуудал үүсгэж болзошгүй. `ADMIN_PASSWORD`-г зөвхөн
   үсэг+тоогоор, зай/тусгай тэмдэггүйгээр (`$ # " '` зэрэггүй) сонгоно уу. Утгыг secret-д
   буулгахдаа урд/хойно нь зай эсвэл мөр таслалт орохгүйг анхаараарай.
